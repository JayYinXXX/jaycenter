...
```javascript
{
    ...
    toc                  : true,           // Table of contents 								自动生成目录
    tocm                 : false,          // Using [TOCM], auto create ToC dropdown menu  		自动为目录创建下拉菜单
    tocTitle             : "",             // for ToC dropdown menu button						下拉菜单的标题
    tocDropdown          : false,          // Enable/disable Table Of Contents dropdown menu	显示下拉菜单
    tocContainer         : "",             // Custom Table Of Contents Container Selector		为目录/下拉菜单指定容器（默认为编辑器内部，分别使用[TOC]/[TOCM]定位）
